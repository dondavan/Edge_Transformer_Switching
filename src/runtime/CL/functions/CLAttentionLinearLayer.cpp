...
#endif
    */
   std::cout << "CLAttentionLinearLayer::run "<<*reinterpret_cast<float *>(_impl->query_input->ptr_to_element(Coordinates(0,0,0))) << std::endl;
   std::cout << "CLAttentionLinearLayer::run "<<*reinterpret_cast<float *>(_impl->key_input->ptr_to_element(Coordinates(0,0,0)))  << std::endl;
   std::cout << "CLAttentionLinearLayer::run "<<*reinterpret_cast<float *>(_impl->value_input->ptr_to_element(Coordinates(0,0,0)))  << std::endl;
    // Q
